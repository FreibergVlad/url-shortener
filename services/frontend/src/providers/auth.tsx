...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const createUser = useMutation<CreateUserResponse, APIError, CreateUserRequest>({
  ...
  const authenticateUser = useMutation<IssueAuthenticationTokenResponse, APIError, IssueAuthenticationTokenRequest>({
    mutationFn: async (request) => {
  ...
  const refreshUserAuthentication = useMutation<RefreshAuthenticationTokenResponse, APIError, undefined>({
    mutationFn: async () => {
      if (!refreshToken) {
