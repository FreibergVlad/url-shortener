...
export const APIProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const useGetOrganizationMemberships = (): UseQueryResult<OrganizationMembership[], APIError> => {
    return useQuery({
      queryFn: async () => {
  ...
  const useCreateOrganization = useMutation<CreateOrganizationResponse, APIError, CreateOrganizationRequest>({
