module github.com/FreibergVlad/url-shortener/url-redirection-service
...
require (
	...
	github.com/FreibergVlad/url-shortener/shared/go v0.0.0-00010101000000-000000000000
