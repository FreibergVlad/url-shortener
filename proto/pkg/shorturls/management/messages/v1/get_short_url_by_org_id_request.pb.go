...
const file_shorturls_management_messages_v1_get_short_url_by_org_id_request_proto_rawDesc = "" +
	"\n" +
	"Fshorturls/management/messages/v1/get_short_url_by_org_id_request.proto\x12 shorturls.management.messages.v1\x1a\x1bbuf/validate/validate.proto\"\x98\x01\n" +
	"\"GetShortURLByOrganizationIDRequest\x124\n" +
